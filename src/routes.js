...
const routes = [
  { path: '/statisticbranch', name: 'Thống kê tài chính chi nhánh', component: StatisticBranch, },
  { path: '/reportbranch', name: 'Báo cáo tài chính chi nhánh', component: ReportBranch, },
