...
const routes = [
  ...
  { path: '/accountchiefmanager', name: 'Tài khoản quan ly truong', component: AccountChiefmanager, roles: ["Admin"] },
  { path: '/managebranch/', name: 'Quản lý chi nhánh', component: ManageBranch, roles: [] },
  { path: '/managepartner/', name: 'Quản lý thông tin đối tác', component: ManagePartner, roles: [] },
  { path: '/managedepartment/', name: 'Quản lý phòng ban', component: ManageDepartment, roles: [] },
  { path: '/manageproduct/', name: 'Quản lý sản phẩm', component: ManageProduct, roles: []},
  { path: '/managetax/', name: 'Quản lý thuế', component: ManageTax, roles: []},

  { path: '/manageemployee/', name: 'Quản lý nhân viên', component: ManageEmployee, roles: []},
